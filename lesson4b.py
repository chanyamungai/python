# Loops -> Sometimes we may need to do a piece of work in repeated times in such cases we may use loops
# A loop is  control structure that enables us to execute a block of code repeatedly until a certain condition is met
# There are two types of loops the for loop and the while loop

# Below is syntax of a for loop in python
"""
for a variable in a range (n)
...
print("========")
# Find even numbers in the range of 50 to 71
